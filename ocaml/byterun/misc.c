...
void (*custom_ocaml_fatal_error_func)(char* fmt, ...) = NULL;
void custom_ocaml_set_fatal_error_func( void (*func)(char* fmt, ...) )
{
	custom_ocaml_fatal_error_func = func;
}
...
{
	if (custom_ocaml_fatal_error_func)
		(*custom_ocaml_fatal_error_func)(#expr);
...
{
	if (custom_ocaml_fatal_error_func)
		(*custom_ocaml_fatal_error_func)(msg);
...
{
	if (custom_ocaml_fatal_error_func)
		(*custom_ocaml_fatal_error_func)(fmt, arg);
...
{
	if (custom_ocaml_fatal_error_func)
		(*custom_ocaml_fatal_error_func)(fmt1, arg1);
